...
Current release: `v1.0.3`. The app can run locally through FastAPI or as a static public demo at `https://pixek.xyz/trustlens/`, with live Gemini/OpenRouter analysis enabled through a server-side backend or an explicitly public browser demo key.
